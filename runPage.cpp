  ...
  QWizardPage (parent)
{
  ...
  progress->fbox = new QGroupBox (tr ("Input file filtering progress"), this);
  ...
  progress->rbox = new QGroupBox (tr ("Total filter progress"), this);
  ...
  progress->rbar->setWhatsThis (tr ("Total progress of filter process"));
